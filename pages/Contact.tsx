        ...
        <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 h-full">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start group">
                  ...
                  <div>
                    ...
                    <a
                      href={`tel:${HOTEL_DETAILS.contact.replace(/\s/g, "")}`}
                ...
                <div className="flex items-start group">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Restaurant: Open until 10:45 PM
                    </p>
              ...
              <div className="mt-8 pt-8 border-t border-gray-100">
                ...
                <p className="text-sm text-gray-600">
                  We are conveniently located near the bus stand on Dungarpur
                  Road. Free parking is available on-site for all guests.
                </p>
              </div>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal delay="0.4s" className="h-full">
            <div className="bg-gray-200 rounded-lg shadow-lg overflow-hidden h-[400px] md:h-auto relative min-h-[400px]">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3473.4855389679756!2d74.01876177511235!3d23.665330478728627!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39673d48d3da4613%3A0xa74f1189113eece0!2sGopi%20Hotel%20and%20Restaurant%20-%20Best%20Hotel%20%26%20Restaurant!5e1!3m2!1sen!2sin!4v1765299703390!5m2!1sen!2sin"
                width="100%"
                height="100%"
                style={{ border: 0 }}
